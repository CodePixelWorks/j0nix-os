...
- Managed GPG passphrases use `gpg-preset-passphrase`, which keeps signing non-interactive after Home Manager activation while leaving the encrypted source in SOPS
