    ...
    if isCaelestiaShell then
      {
        ...
        bind = [
          ...
          "$mainMod, b, exec, ${appExec "app2unit -- ${settings.preferredBrowser or "chromium"}"}"
          "$mainMod, e, exec, ${appExec "app2unit -- ${settings.preferredEditor or "nvim"}"}"
          "$mainMod ALT, e, exec, ${appExec "app2unit -- ${preferredFileManager}"}"
          "$mainMod, g, exec, ${appExec "app2unit -- github-desktop"}"
          "CTRL ALT, v, exec, ${appExec "app2unit -- pavucontrol"}"
          "CTRL ALT, Escape, exec, ${appExec "app2unit -- qps"}"
