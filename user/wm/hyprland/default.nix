...
let
  ...
  baseHyprKeybinds = {
    bind = [
      ...
      "$mainMod SHIFT, left, movetoworkspace, special:left"
      "$mainMod SHIFT, right, movetoworkspace, special:right"
      "$mainMod SHIFT, up, movewindow, u"
      "$mainMod SHIFT, down, movewindow, d"
      "$mainMod CTRL, left, togglespecialworkspace, left"
      "$mainMod CTRL, right, togglespecialworkspace, right"
