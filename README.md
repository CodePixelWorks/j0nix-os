...
**🖥️ j0nix-os — A declarative, flake-driven NixOS ecosystem built for gaming and creative work. Features modular system/user separation, pluggable Hyprland shell layers, and reproducible multi-user environments managed through Home Manager.**
...
| [docs/wm/startup-flow.md](docs/wm/startup-flow.md) | How WM startup works (display manager → shell → apps) |
| [docs/wm/qmlgreet.md](docs/wm/qmlgreet.md) | QMLGreet greeter configuration and theming |
| [docs/wm/keybinds.md](docs/wm/keybinds.md) | Current keybind reference (caelestia-shell default) |
| [docs/wm/quickshell/caelestia.md](docs/wm/quickshell/caelestia.md) | Caelestia shell keybind stability runbook |
...
| 2 | **Hibernate / Standby** | Not functional | Suspend-to-disk (hibernate) and reliable standby — needs resume device, swap, and kernel param alignment with the profile boundary |
