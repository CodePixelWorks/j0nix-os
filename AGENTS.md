...
8. `.example` files are templates only. Never import or evaluate them as silent fallbacks in the flake, profiles, or modules; if a required real file is missing, fail with a clear error message instead.
