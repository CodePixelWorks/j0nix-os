...
- `nix/user/wm/hyprland/config/window-rules.nix`
...
- Additional shell-specific media, screenshot, and workflow binds are defined in the selected shell block inside `nix/user/wm/hyprland/default.nix`.
