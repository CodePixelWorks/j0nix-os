...
let
  ...
  #
  # RLM_LICENSE points to the fake blackmagic.lic placed by the patched
  # derivation (resolvepatch approach).  bwrap inherits env vars (no
  # --clearenv) and /nix is always mounted, so the store path works
